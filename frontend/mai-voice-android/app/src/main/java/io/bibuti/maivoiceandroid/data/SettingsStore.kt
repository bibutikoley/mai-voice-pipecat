...
class SettingsStore(private val context: Context) {
    ...
    val speakerEnabled: Flow<Boolean> = context.settingsDataStore.data.map { prefs ->
        prefs[SPEAKER_ENABLED_KEY] ?: true
    }
    ...
    suspend fun setSpeakerEnabled(enabled: Boolean) {
        context.settingsDataStore.edit { prefs -> prefs[SPEAKER_ENABLED_KEY] = enabled }
    }
